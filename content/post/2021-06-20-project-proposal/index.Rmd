...
<!--- This is getting pretty complicated. I'm not sure exactly what you are trying to accomplish here or whether it's possible. Perhaps options pricing models might work, but those typically assume an underlying rationality--a dubious assumption in this case. My bet is that you'd have more luck looking for external drivers of price movement (i.e. news / twitter). -->
...
<!--- and may only work well because prices have been on a steady rise -->
...
<!--- risky project. Let's see what the group says when you present -->
