...
```
Data: All data gathered from https://www.coindesk.com/price/ (updated: 08/04/2021). 
...
With this this buy/sell model, let's see what happened if we followed the model's buy/sell predictions. Say we  first purchase Bitcoin on  1/02, sold on 01/19, purchased again on 02/07, sold on 02/24, purchased on 03/07, sold on 03/20, purchased on 03/29, and finally sold again on 04/05, all in accordance with the trigger we designed.

To be more realistic, let's assume we bought 3.11% of a Bitcoin for $1,000 on 01/02 of this year.
...
Overall, this model made 1,971.65 dollars or 197% in profit. 
...
This is about 805 dollars of profit, which shows that our model is more profitable than inaction.
...
Learn more about how you can acquire cryptocurrency without purchasing it [here](https://amoderninvestor.netlify.app/27/2021/01/) or how quantum computers can help miners work more efficiently [here](https://amoderninvestor.netlify.app/22/2021/01/).
